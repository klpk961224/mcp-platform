...
class Announcement(BaseModel):
    ...
    publisher_id = Column(String(50), ForeignKey("users.id", ondelete="SET NULL"), nullable=True, comment="发布者ID")
    ...
    is_top = Column(Integer, nullable=False, default=0, comment="是否置顶")
...
class AnnouncementRead(BaseModel):
    ...
    announcement_id = Column(String(50), ForeignKey("announcements.id", ondelete="CASCADE"), nullable=False, comment="通知公告ID")
