...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(100), nullable=False, comment='妯℃澘名称'),
        sa.Column('code', sa.String(100), nullable=False, unique=True, comment='妯℃澘编码'),
        ...
        sa.Column('created_by', sa.String(50), comment='创建浜篒D'),
    ...
    op.create_table(
        ...
        sa.Column('node_name', sa.String(100), nullable=False, comment='鑺傜偣名称'),
        sa.Column('node_type', sa.String(20), nullable=False, comment='鑺傜偣类型'),
