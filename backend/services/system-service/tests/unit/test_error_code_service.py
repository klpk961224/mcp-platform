...
娴嬭瘯鍐呭锛?1. 鍒涘缓閿欒鐮?2. 鑾峰彇閿欒鐮?3. 鏇存柊閿欒鐮?4. 鍒犻櫎閿欒鐮?5. 鑾峰彇閿欒鐮佸垪琛?6. 鎸夋ā鍧楄幏鍙栭敊璇爜
7. 鎸夌骇鍒幏鍙栭敊璇爜
...
class TestErrorCodeService:
    ...
    def test_get_error_code_by_id_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鏍规嵁ID鑾峰彇閿欒鐮佹垚鍔?""
        # 妯℃嫙鏌ヨ閿欒鐮?        error_code_service.repository.get_by_id = Mock(return_value=mock_error_code)
    ...
    def test_get_error_code_by_code_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鏍规嵁閿欒鐮佽幏鍙栨垚鍔?""
        # 妯℃嫙鏌ヨ閿欒鐮?        error_code_service.repository.get_by_code = Mock(return_value=mock_error_code)
    ...
    def test_get_all_error_codes_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鑾峰彇鎵€鏈夐敊璇爜鎴愬姛"""
        # 妯℃嫙鏌ヨ閿欒鐮佸垪琛?        error_code_service.repository.get_all = Mock(return_value=[mock_error_code])
    ...
    def test_get_error_codes_by_module_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鎸夋ā鍧楄幏鍙栭敊璇爜鎴愬姛"""
        # 妯℃嫙鏌ヨ閿欒鐮佸垪琛?        error_code_service.repository.get_by_module = Mock(return_value=[mock_error_code])
    ...
    def test_get_error_codes_by_level_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鎸夌骇鍒幏鍙栭敊璇爜鎴愬姛"""
        # 妯℃嫙鏌ヨ閿欒鐮佸垪琛?        error_code_service.repository.get_by_level = Mock(return_value=[mock_error_code])
    ...
    def test_create_error_code_success(self, error_code_service, mock_error_code):
        ...
        # 妯℃嫙鍒涘缓閿欒鐮?        error_code_service.repository.create = Mock(return_value=mock_error_code)
        
        # 鎵ц鍒涘缓閿欒鐮?        result = error_code_service.create_error_code(
            code="ERR001",
            message="绯荤粺閿欒",
            module="system",
            level="error"
    ...
    def test_update_error_code_success(self, error_code_service, mock_error_code):
        """娴嬭瘯鏇存柊閿欒鐮佹垚鍔?""
        # 妯℃嫙鏌ヨ閿欒鐮?        error_code_service.repository.get_by_id = Mock(return_value=mock_error_code)
        # 妯℃嫙鏇存柊閿欒鐮?        error_code_service.repository.update = Mock(return_value=mock_error_code)
        
        # 鎵ц鏇存柊
        result = error_code_service.update_error_code(
            "test_error_code_id",
            message="鏇存柊鍚庣殑閿欒淇℃伅"
        )
    ...
    def test_delete_error_code_success(self, error_code_service):
        """娴嬭瘯鍒犻櫎閿欒鐮佹垚鍔?""
        # 妯℃嫙鍒犻櫎閿欒鐮?        error_code_service.repository.delete = Mock(return_value=True)
